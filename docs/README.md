...
- ![function](https://img.shields.io/badge/function-purple) &nbsp;[tmqmrdfdata.download_tmQM_RDF_knowledge_graph](#-tmqmrdfdatadownload_tmqm_rdf_knowledge_graph): download utility for tmQM-RDF
...
## ![function](https://img.shields.io/badge/function-purple) tmqmrdfdata.download_tmQM_RDF_knowledge_graph
```python
